...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           mult;
   Float_t         pt[8577];   //[mult]
   Float_t         eta[8577];   //[mult]
   Float_t         phi[8577];   //[mult]
   Int_t           pdg[8577];   //[mult]
   Int_t           chg[8577];   //[mult]
   ...
   Float_t         jetphi[6];   //[njet]
   Float_t         gjetpt[6];   //[njet]
   Float_t         gjeteta[6];   //[njet]
   Float_t         gjetphi[6];   //[njet]
   Int_t           jetID[6];   //[njet]
   Int_t           subid[6];   //[njet]
   ...
   Float_t         jeteta_mix[15];   //[njet_mix]
   Float_t         jetphi_mix[15];   //[njet_mix]
   Int_t           nmixEv_mix[15];   //[njet_mix]
   Int_t           jetID_mix[15];   //[njet_mix]
   Float_t         neutralSum_mix[15];   //[njet_mix]
   Float_t         chargedSum_mix[15];   //[njet_mix]
   Int_t           chargedN_mix[15];   //[njet_mix]
   Int_t           photonN_mix[15];   //[njet_mix]
   Int_t           neutralN_mix[15];   //[njet_mix]
   Int_t           eN_mix[15];   //[njet_mix]
   Int_t           muN_mix[15];   //[njet_mix]
   Float_t         chargedMax_mix[15];   //[njet_mix]
   Float_t         photonSum_mix[15];   //[njet_mix]
   Float_t         eSum_mix[15];   //[njet_mix]
   Int_t           nTrk;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../g.Pythia8_Photon_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_forest_v1.root.mix");
      if (!f || !f->IsOpen()) {
         f = new TFile("../g.Pythia8_Photon_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_forest_v1.root.mix");
      }
