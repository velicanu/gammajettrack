...
if [ $6 = "pbpbdata" ]; then
    SKIM="/export/d00/scratch/biran/photon-jet-track/PbPb-Data-skim-170509.root"
    TYPE="recoreco"
    MCSKIM="/export/d00/scratch/biran/photon-jet-track/PbPb-MC-skim-170509.root"
    MCSAMPLE="pbpbmc"
elif [ $6 = "ppdata" ]; then
    SKIM="/export/d00/scratch/biran/photon-jet-track/pp-Data-skim-170509.root"
    TYPE="srecoreco"
    MCSKIM="/export/d00/scratch/biran/photon-jet-track/pp-MC-skim-170509.root"
    MCSAMPLE="ppmc"
else
    echo "invalid sample"
    exit 1
