...
//! 1-2: rjet_mix rtrk_mix
            if(signal) {
              hgammaffxijetmix->Fill(xi,trkWeight[itrk_mix]/nmixedjetevents);
            }
            if(sideband) {
              hgammaffxijetmixsideband->Fill(xi,trkWeight[itrk_mix]/nmixedjetevents);
            }
          }
        }
      }
