...
./plot_ff nominal_xijet.root gammaxi0_sys_plot.root sysSummary_result_all 0 all
...
./add_sys.exe gammaxi0_sys.root gammaxi0_sys_plot.root
./plot_ff nominal_xijet.root gammaxi0_sys_plot.root sysSummary_result_JES 0 JES
...
./add_sys.exe gammaxi0_sys.root gammaxi0_sys_plot.root
./plot_ff nominal_xijet.root gammaxi0_sys_plot.root sysSummary_result_purity 0 purity
...
./add_sys.exe gammaxi0_sys.root gammaxi0_sys_plot.root
./plot_ff nominal_xijet.root gammaxi0_sys_plot.root sysSummary_result_JER 0 JER
...
./add_sys.exe gammaxi0_sys.root gammaxi0_sys_plot.root
./plot_ff nominal_xijet.root gammaxi0_sys_plot.root sysSummary_result_pes 0 pes
...
./add_sys.exe gammaxi0_sys.root gammaxi0_sys_plot.root
./plot_ff nominal_xijet.root gammaxi0_sys_plot.root sysSummary_result_trk 0 trk
