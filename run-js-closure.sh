...
for i in ${@:6}
do
  ./jetshape /export/d00/scratch/biran/photon-jet-track/PbPb-MC-skim-170406.root pbpbmc 0 20 $1 $2 $3 $i $4 $5 &
  ./jetshape /export/d00/scratch/biran/photon-jet-track/PbPb-MC-skim-170406.root pbpbmc 20 60 $1 $2 $3 $i $4 $5 &
  ./jetshape /export/d00/scratch/biran/photon-jet-track/PbPb-MC-skim-170406.root pbpbmc 60 100 $1 $2 $3 $i $4 $5 &
  ./jetshape /export/d00/scratch/biran/photon-jet-track/PbPb-MC-skim-170406.root pbpbmc 100 200 $1 $2 $3 $i $4 $5 &
done
wait
