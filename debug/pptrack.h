...
// Fri May  6 15:10:42 2016 by ROOT version 6.02/13
// from TTree trackTree/v1
// found on file: /mnt/hadoop/cms/store/user/velicanu/Merged/pp_Pythia8_Ze10e10Jet_m60120_pthat0_TuneCUETP8M1_5020GeV_GEN_SIM_20160110_FOREST_v24/0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         trkPt[122];   //[nTrk]
   Float_t         trkPtError[122];   //[nTrk]
   UChar_t         trkNHit[122];   //[nTrk]
   UChar_t         trkNlayer[122];   //[nTrk]
   Float_t         trkEta[122];   //[nTrk]
   Float_t         trkPhi[122];   //[nTrk]
   Int_t           trkCharge[122];   //[nTrk]
   UChar_t         trkNVtx[122];   //[nTrk]
   Int_t           nTrkTimesnVtx;
   Bool_t          trkAssocVtx[264];   //[nTrkTimesnVtx]
   Float_t         trkDxyOverDxyError[264];   //[nTrkTimesnVtx]
   Float_t         trkDzOverDzError[264];   //[nTrkTimesnVtx]
   Bool_t          highPurity[122];   //[nTrk]
   Bool_t          tight[122];   //[nTrk]
   Bool_t          loose[122];   //[nTrk]
   Float_t         trkChi2[122];   //[nTrk]
   UChar_t         trkNdof[122];   //[nTrk]
   Float_t         trkDxy1[122];   //[nTrk]
   Float_t         trkDxyError1[122];   //[nTrk]
   Float_t         trkDz1[122];   //[nTrk]
   Float_t         trkDzError1[122];   //[nTrk]
   Bool_t          trkFake[122];   //[nTrk]
   UChar_t         trkAlgo[122];   //[nTrk]
   UChar_t         trkOriginalAlgo[122];   //[nTrk]
   Float_t         trkMVA[122];   //[nTrk]
   Bool_t          trkMVALoose[122];   //[nTrk]
   Bool_t          trkMVATight[122];   //[nTrk]
   Int_t           pfType[122];   //[nTrk]
   Float_t         pfCandPt[122];   //[nTrk]
   Float_t         pfEcal[122];   //[nTrk]
   Float_t         pfHcal[122];   //[nTrk]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/hadoop/cms/store/user/velicanu/Merged/pp_Pythia8_Ze10e10Jet_m60120_pthat0_TuneCUETP8M1_5020GeV_GEN_SIM_20160110_FOREST_v24/0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/mnt/hadoop/cms/store/user/velicanu/Merged/pp_Pythia8_Ze10e10Jet_m60120_pthat0_TuneCUETP8M1_5020GeV_GEN_SIM_20160110_FOREST_v24/0.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/mnt/hadoop/cms/store/user/velicanu/Merged/pp_Pythia8_Ze10e10Jet_m60120_pthat0_TuneCUETP8M1_5020GeV_GEN_SIM_20160110_FOREST_v24/0.root:/ppTrack");
