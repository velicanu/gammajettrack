...
void drawclosureffgamma() {
  ...
  for (int icent = 0; icent < 5; icent++) {
    ...
    if(icent==0)
    {
      leg_ff_pbpbsub[icent]->AddEntry(clone_hgammaffxi_pbpbmc_gen_[icent],"gen jet #eta,#phi ff","p");
      leg_ff_pbpbsub[icent]->AddEntry(clone_hgammaffxi_pbpbmc_[icent],"reco jet #eta,#phi ff","p");
    }
    else if(icent==1)
    {
  ...
  for (int icent = 0; icent < 5; icent++) {
    ...
    if(icent==0)
    {
      leg_ff_pbpbsub2[icent]->AddEntry(clone2_hgammaffxi_pbpbmc_gen_[icent],"gen jet/reco jet #eta,#phi ff","p");
