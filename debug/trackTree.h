...
// Fri May  6 16:07:54 2016 by ROOT version 6.02/13
// from TTree trackTree/v1
// found on file: /mnt/hadoop/cms/store/user/rbi/merged/azsigmon-HIRun2015E-PromptReco-AOD-DimuonSkim-Mass40-v3_forest_csjet_v1_2/0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         trkPt[37109];   //[nTrk]
   Float_t         trkPtError[37109];   //[nTrk]
   UChar_t         trkNHit[37109];   //[nTrk]
   UChar_t         trkNlayer[37109];   //[nTrk]
   Float_t         trkEta[37109];   //[nTrk]
   Float_t         trkPhi[37109];   //[nTrk]
   Int_t           trkCharge[37109];   //[nTrk]
   UChar_t         trkNVtx[37109];   //[nTrk]
   Int_t           nTrkTimesnVtx;
   Bool_t          trkAssocVtx[37109];   //[nTrkTimesnVtx]
   Float_t         trkDxyOverDxyError[37109];   //[nTrkTimesnVtx]
   Float_t         trkDzOverDzError[37109];   //[nTrkTimesnVtx]
   Bool_t          highPurity[37109];   //[nTrk]
   Bool_t          tight[37109];   //[nTrk]
   Bool_t          loose[37109];   //[nTrk]
   Float_t         trkChi2[37109];   //[nTrk]
   UChar_t         trkNdof[37109];   //[nTrk]
   Float_t         trkDxy1[37109];   //[nTrk]
   Float_t         trkDxyError1[37109];   //[nTrk]
   Float_t         trkDz1[37109];   //[nTrk]
   Float_t         trkDzError1[37109];   //[nTrk]
   Bool_t          trkFake[37109];   //[nTrk]
   UChar_t         trkAlgo[37109];   //[nTrk]
   UChar_t         trkOriginalAlgo[37109];   //[nTrk]
   Float_t         trkMVA[37109];   //[nTrk]
   Bool_t          trkMVATight[37109];   //[nTrk]
   Int_t           pfType[37109];   //[nTrk]
   Float_t         pfCandPt[37109];   //[nTrk]
   Float_t         pfEcal[37109];   //[nTrk]
   Float_t         pfHcal[37109];   //[nTrk]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/hadoop/cms/store/user/rbi/merged/azsigmon-HIRun2015E-PromptReco-AOD-DimuonSkim-Mass40-v3_forest_csjet_v1_2/0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/mnt/hadoop/cms/store/user/rbi/merged/azsigmon-HIRun2015E-PromptReco-AOD-DimuonSkim-Mass40-v3_forest_csjet_v1_2/0.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/mnt/hadoop/cms/store/user/rbi/merged/azsigmon-HIRun2015E-PromptReco-AOD-DimuonSkim-Mass40-v3_forest_csjet_v1_2/0.root:/anaTrack");
