...
void draw2step(int phoetmin, int phoetmax, int jetptmin = 30, int trkptcut = 4) {
  ...
  for (int icent = 0; icent < ncentbins; icent++) {
    ...
    hgammaffxiuemix_pbpbmc_recoreco[icent]->Scale(1/nrawjets);
    ...
    if(icent==0)
    {
      leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recoreco[icent],"Raw FF - Jet Mix FF","p");
      leg_ff_pbpbsub[icent]->AddEntry(hgammaffxiuemix_pbpbmc_recoreco[icent],"UE Mix FF","p");
    }
    else if(icent==1)
    {
