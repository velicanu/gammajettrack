...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     ffgammajet(std::string label, int centmin = -1, int centmax = 200, float phoetmin = 100, float phoetmax = 300, int jetptcut = 30, std::string gen = "", int checkjetid = 1, int trkptmin = 1, int gammaxi = 0, int doJERsys = 0);
