...
./gammajetSkim.exe /mnt/hadoop/cms/store/user/rbi/merged/Pythia8_Photon15_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_forest_v1/0.root /export/d00/scratch/dav2105/ztrees/g.Pythia8_Photon15_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_v13-v1_forest_v1.root akPu3PFJetAnalyzer 0 0.999565 &
./gammajetSkim.exe /mnt/hadoop/cms/store/user/rbi/merged/Pythia8_Photon30_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_v13-v1_forest_v1/0.root /export/d00/scratch/dav2105/ztrees/g.Pythia8_Photon30_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_v13-v1_forest_v1.root akPu3PFJetAnalyzer 0 0.187379 &
./gammajetSkim.exe /mnt/hadoop/cms/store/user/rbi/merged/Pythia8_Photon50_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_forest_v1/0.root /export/d00/scratch/dav2105/ztrees/g.Pythia8_Photon50_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_forest_v1.root akPu3PFJetAnalyzer 0 0.0434138 &
./gammajetSkim.exe /mnt/hadoop/cms/store/user/rbi/merged/Pythia8_Photon80_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_forest_v1/0.root /export/d00/scratch/dav2105/ztrees/g.Pythia8_Photon80_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_forest_v1.root akPu3PFJetAnalyzer 0 0.0094069 &
./gammajetSkim.exe /mnt/hadoop/cms/store/user/rbi/merged/Pythia8_Photon120_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_forest_v1/0.root /export/d00/scratch/dav2105/ztrees/g.Pythia8_Photon120_Hydjet_MB-HINPbPbWinter16DR-75X_mcRun2_HeavyIon_forest_v1.root akPu3PFJetAnalyzer 0 0.00211448 &
