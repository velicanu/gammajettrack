...
./ffgamma.exe /export/d00/scratch/dav2105/ztrees/g.HIPhoton40AndZ-PbPb-photonHLTFilter-24ev.root pbpbdata 0 20 $1 $2 $3 recoreco $4 $5 $6 &
./ffgamma.exe /export/d00/scratch/dav2105/ztrees/g.HIPhoton40AndZ-PbPb-photonHLTFilter-24ev.root pbpbdata 20 60 $1 $2 $3 recoreco $4 $5 $6 &
#wait
./ffgamma.exe /export/d00/scratch/dav2105/ztrees/g.HIPhoton40AndZ-PbPb-photonHLTFilter-24ev.root pbpbdata 60 100 $1 $2 $3 recoreco $4 $5 $6 &
...
./ffgamma.exe /export/d00/scratch/dav2105/ztrees/g.HIPhoton40AndZ-PbPb-photonHLTFilter-24ev.root pbpbdata 100 200 $1 $2 $3 recoreco $4 $5 $6 &
#wait
