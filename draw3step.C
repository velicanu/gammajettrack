...
void draw3step(int phoetmin, int phoetmax, int jetptmin = 30, int trkptcut = 4, int do_divide=0, int gammaxi = 0) {
  ...
  TH1D * rawff_pbpbmc_recogen[ncentbins];
  TH1D * rawffue_pbpbmc_recogen[ncentbins];
  TH1D * rawffjetmix_pbpbmc_recogen[ncentbins];
  TH1D * rawffjetmixue_pbpbmc_recogen[ncentbins];
  TH1D * hjetpt_pbpbmc_recogen[ncentbins];
  TH1D * hjetptjetmix_pbpbmc_recogen[ncentbins];

  TH1D * rawffsideband_pbpbmc_recogen[ncentbins];
  TH1D * rawffuesideband_pbpbmc_recogen[ncentbins];
  TH1D * rawffjetmixsideband_pbpbmc_recogen[ncentbins];
  TH1D * rawffjetmixuesideband_pbpbmc_recogen[ncentbins];
  TH1D * hjetptsideband_pbpbmc_recogen[ncentbins];
  TH1D * hjetptjetmixsideband_pbpbmc_recogen[ncentbins];
  ...
  for (int icent = 0; icent < ncentbins; icent++) {
    ...
    rawff_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hgammaffxi_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    rawff_pbpbmc_recogen[icent]->Sumw2();
    rawffue_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hgammaffxiuemix_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    rawffue_pbpbmc_recogen[icent]->Sumw2();
    rawffjetmix_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hgammaffxijetmix_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    rawffjetmix_pbpbmc_recogen[icent]->Sumw2();
    rawffjetmixue_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hgammaffxijetmixue_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    rawffjetmixue_pbpbmc_recogen[icent]->Sumw2();
    rawffue_pbpbmc_recogen[icent]->Scale(-1);
    rawffjetmixue_pbpbmc_recogen[icent]->Scale(-1);
    rawff_pbpbmc_recogen[icent]->Add(rawffue_pbpbmc_recogen[icent]);
    rawffjetmix_pbpbmc_recogen[icent]->Add(rawffjetmixue_pbpbmc_recogen[icent]);
    rawffjetmix_pbpbmc_recogen[icent]->Scale(-1);
    rawff_pbpbmc_recogen[icent]->Add(rawffjetmix_pbpbmc_recogen[icent]);

    hjetpt_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hjetpt_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    hjetptjetmix_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hjetptjetmix_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));

    float nrawjets = hjetpt_pbpbmc_recogen[icent]->Integral();
    float nmixjets = hjetptjetmix_pbpbmc_recogen[icent]->Integral();


    rawff_pbpbmc_recogen[icent]->Scale(1/(nrawjets-nmixjets));


    rawffsideband_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hgammaffxisideband_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    rawffsideband_pbpbmc_recogen[icent]->Sumw2();
    rawffuesideband_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hgammaffxiuemixsideband_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    rawffuesideband_pbpbmc_recogen[icent]->Sumw2();
    rawffjetmixsideband_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hgammaffxijetmixsideband_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    rawffjetmixsideband_pbpbmc_recogen[icent]->Sumw2();
    rawffjetmixuesideband_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hgammaffxijetmixuesideband_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    rawffjetmixuesideband_pbpbmc_recogen[icent]->Sumw2();
    rawffuesideband_pbpbmc_recogen[icent]->Scale(-1);
    rawffjetmixuesideband_pbpbmc_recogen[icent]->Scale(-1);
    rawffsideband_pbpbmc_recogen[icent]->Add(rawffuesideband_pbpbmc_recogen[icent]);
    rawffjetmixsideband_pbpbmc_recogen[icent]->Add(rawffjetmixuesideband_pbpbmc_recogen[icent]);
    rawffjetmixsideband_pbpbmc_recogen[icent]->Scale(-1);
    rawffsideband_pbpbmc_recogen[icent]->Add(rawffjetmixsideband_pbpbmc_recogen[icent]);

    hjetptsideband_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hjetptsideband_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));
    hjetptjetmixsideband_pbpbmc_recogen[icent] = (TH1D*)_file0->Get(Form("hjetptjetmixsideband_pbpbmc_recogen_%d_%d",centmins[icent],centmaxs[icent]));

    float nrawjetssideband = hjetptsideband_pbpbmc_recogen[icent]->Integral();
    float nmixjetssideband = hjetptjetmixsideband_pbpbmc_recogen[icent]->Integral();


    rawffsideband_pbpbmc_recogen[icent]->Scale(1/(nrawjetssideband-nmixjetssideband));
    rawffsideband_pbpbmc_recogen[icent]->SetMarkerColor(kGreen);
    // rawffsideband_pbpbmc_recogen[icent]->Draw("same");

    float purity   = getpurity(phoetmin,centmins[icent],false);
    float pppurity = getpurity(phoetmin,centmins[icent],true);
    rawff_pbpbmc_recogen[icent]->Scale(1.0/purity);
    rawffsideband_pbpbmc_recogen[icent]->Scale(-1.0*(1.0-purity)/purity);
    rawff_pbpbmc_recogen[icent]->Add(rawffsideband_pbpbmc_recogen[icent]);
    ...
    nrawjets = hjetpt_pbpbmc_recoreco[icent]->Integral();
    nmixjets = hjetptjetmix_pbpbmc_recoreco[icent]->Integral();
    ...
    nrawjetssideband = hjetptsideband_pbpbmc_recoreco[icent]->Integral();
    nmixjetssideband = hjetptjetmixsideband_pbpbmc_recoreco[icent]->Integral();
    ...
    purity   = getpurity(phoetmin,centmins[icent],false);
    pppurity = getpurity(phoetmin,centmins[icent],true);
    ...
    if(do_divide==0) {
      rawff_pbpbmc_recogen[icent]->Draw("same");
      rawff_pbpbmc_recoreco[icent]->Draw("hist same");
    } else {
      rawff_pbpbmc_recogen[icent]->Divide(rawff_pbpbmc_recoreco[icent]);
      rawff_pbpbmc_recogen[icent]->Draw("same");
      TLine * lone = new TLine(0,1,5,1);
      lone->SetLineStyle(9);
      lone->Draw();
    }
    rawff_pbpbmc_recogen[icent]->Write();
    ...
    {
      if(do_divide==0) {
        leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recogen[icent],"recogen bkg-sub","p");
        leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recoreco[icent],"recoreco bkg-sub","l");
      } else {
        leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recogen[icent],"recogen/recoreco","p");
        leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recoreco[icent],"","");
      }
      // leg_ff_pbpbsub[icent]->AddEntry(rawffjetmix_pbpbmc_recogen[icent],"Jet Mix FF","p");
      // leg_ff_pbpbsub[icent]->AddEntry(rawffue_pbpbmc_recogen[icent],"Raw UE FF","p");
      // leg_ff_pbpbsub[icent]->AddEntry(rawffjetmixue_pbpbmc_recogen[icent],"Jet Mix UE FF","p");
    }
    else if(icent==1)
    {
      leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recogen[icent],Form("trk p_{T}>%d GeV, R < 0.3",trkptcut),"");
      leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recogen[icent],Form("%d>#gamma p_{T}>%d GeV",phoetmin,phoetmax),"");
    }
    else if(icent==2)
    {
      leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recogen[icent],"|#eta^{jet}| < 1.6","");
      leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recogen[icent],Form("p_{T}^{jet} > %d GeV",jetptmin),"");
    }
    else if(icent==3)
    {
      leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recogen[icent],"Pythia+Hydjet","");
      leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recogen[icent],"#sigma_{i#eta#eta}<0.10","");
    }
    leg_ff_pbpbsub[icent]->AddEntry(rawff_pbpbmc_recogen[icent],Form("%s",cents[icent].data()),"");
  ...
  ldndxi->Draw();
  if(do_divide==0) {
    call->SaveAs(Form("finalff_%d_%d_uemixff_jetpt%d_pbpbmc_recogenrecoreco_%d.png",phoetmin,phoetmax,jetptmin,gammaxi));
    call->SaveAs(Form("finalff_%d_%d_uemixff_jetpt%d_pbpbmc_recogenrecoreco_%d.pdf",phoetmin,phoetmax,jetptmin,gammaxi));
  } else {
    call->SaveAs(Form("finalff_%d_%d_uemixff_jetpt%d_pbpbmc_recogenrecoreco_%d_ratio.png",phoetmin,phoetmax,jetptmin,gammaxi));
    call->SaveAs(Form("finalff_%d_%d_uemixff_jetpt%d_pbpbmc_recogenrecoreco_%d_ratio.pdf",phoetmin,phoetmax,jetptmin,gammaxi));
  }
  // _fout->Write();
  _fout->Save();
}
