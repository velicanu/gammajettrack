...
./plot_ff nominal_xigamma.root gammaxi1_sys_plot.root sysSummary_result_all 0 all
...
./add_sys.exe gammaxi1_sys.root gammaxi1_sys_plot.root
./plot_ff nominal_xigamma.root gammaxi1_sys_plot.root sysSummary_result_JES 0 JES
...
./add_sys.exe gammaxi1_sys.root gammaxi1_sys_plot.root
./plot_ff nominal_xigamma.root gammaxi1_sys_plot.root sysSummary_result_purity 0 purity
...
./add_sys.exe gammaxi1_sys.root gammaxi1_sys_plot.root
./plot_ff nominal_xigamma.root gammaxi1_sys_plot.root sysSummary_result_JER 0 JER
./plot_ff_ratio nominal_xigamma_ratio.root gammaxi1_sys_plot.root sysSummary_result_ratio_JER JER
./plot2ff nominal_xigamma.root systjer_mix_xigamma.root sysSummary_JER 0 JER 0
./plot2ff nominal_xigamma.root systjer_mix_xigamma.root sysSummary_JER_ratio 0 JER 1
...
./add_sys.exe gammaxi1_sys.root gammaxi1_sys_plot.root
./plot_ff nominal_xigamma.root gammaxi1_sys_plot.root sysSummary_result_pes 0 pes
...
./add_sys.exe gammaxi1_sys.root gammaxi1_sys_plot.root
./plot_ff nominal_xigamma.root gammaxi1_sys_plot.root sysSummary_result_trk 0 trk
